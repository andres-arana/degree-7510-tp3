...
/**
 * Interfaz para implementar una Oferta. La oferta esta compuesta
...
public interface IOferta {
	...
	/**
	 * Aplica la oferta a los productos que corresponda o a toda la venta, segun el 
	 * tipo de oferta
	...
	/**
	 * Si al aplicar una oferta existen mas productos a los cuales se puede aplicar
	 * la misma oferta, la oferta se aplica recurrentemente. Este metodo da a conocer
